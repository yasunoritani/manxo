...
public:
    MIN_DESCRIPTION {"Native State Synchronization Engine for Max 8-Claude Desktop"};
    MIN_TAGS {"mcp-bridge"};
    ...
    attribute<symbol> storage_path { this, "storage", "~/Documents/Max 8/state",
...
void mcp_state_sync::initialize() {
    ...
    current_session = std::make_unique<mcp::state::Session>(session_id, "Max 8 Session");
